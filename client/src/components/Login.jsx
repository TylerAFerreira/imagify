    ...
    return (
        <div className=' absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
            ...
            >
                ...
                <p className='text-sm'>Content de te revoir! Veuillez vous connecter pour continuer</p>
                ...
                <p className='text-sm text-blue-600 my-4 cursor-pointer'>Mot de passe oublié ?</p>

                <button className='bg-blue-600 w-full text-white py-2 rounded-full'>{state === 'Login' ? 'Se Connecter' : 'Créer un compte'}</button>

                {state === "Login"
                    ? <p className='mt-5 text-center'>Vous n'avez pas de compte ? <span onClick={() => setState('Sign Up')} className='text-blue-600 cursor-pointer'>S'inscrire</span></p>
                    : <p className='mt-5 text-center'>Vous avez déjà un compte ? <span onClick={() => setState('Login')} className='text-blue-600 cursor-pointer'>Se connecter</span></p>
                }
