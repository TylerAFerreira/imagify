...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            >
                Transformez le texte en <span className='text-blue-600'>image</span>, en quelques secondes.
            </motion.h1>
            ...
            >
                Libérez votre créativité avec l'IA. Transformez votre imagination en art visuel en quelques secondes : tapez simplement et regardez la magie opérer.
            </motion.p>
            ...
            >
                Générer des Images <img className='h-6' src={assets.star_group} alt="" />
            </motion.button>
            ...
            >
                Images générées à partir d'imagify
            </motion.p>
        </motion.div>
    )
}
